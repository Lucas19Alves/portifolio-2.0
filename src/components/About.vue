<template>
  <section id="about" class="section-padding bg-white">
    <div class="container mx-auto">
      <h2 class="text-4xl font-bold text-center mb-12" data-aos="fade-up">Sobre Mim</h2>
      <div class="grid md:grid-cols-2 gap-12 items-center">
        <div data-aos="fade-right">
          <img src="../assets/perfil.jpeg" alt="Lucas" class="rounded-lg shadow-lg w-full max-w-md mx-auto">
        </div>
        <div data-aos="fade-left">
          ...
          <div class="space-y-4">
            <div class="flex items-center">
              <span class="font-semibold w-32">Experiência:</span>
              <span class="text-gray-600">+3 anos</span>
            </div>
            <div class="flex items-center">
            ...
            <div class="flex items-center">
              ...
              <a href="mailto:lucaas19alves@gmail.com" class="text-primary hover:underline transition-colors">
                lucaas19alves@gmail.com
              </a>
            </div>
          </div>
        </div>
